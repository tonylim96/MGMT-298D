...
list.of.packages <- c("caTools", "ROCR")
...
In the training data, which outcome for TenYearCHD is most likely? Suppose we use this outcome as our prediction in a baseline model. What is the accuracy of a baseline model? Hint: use the table() function to see raw observation counts.
