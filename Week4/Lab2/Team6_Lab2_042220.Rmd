...
The results from the regression differs from Table 3 from Meltzer and Jena. Some possible explanations could be that our dataset included extra categories not included in the article's dataset (e.g., included ages below 25, marital status of refused/unsure, race status of other/multi, and income status of refused/unsure). Our dataset had a sample size of 6,371 while the article's dataset had a sample size of 6,135. 
